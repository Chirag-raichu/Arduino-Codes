...
String apiKey = "3LT1EMICJ5VHK06W";     // replace with your channel's thingspeak WRITE API key

String ssid="Ajith ajay";    // Wifi network SSID
...
void setup() {                
  ...
  espSerial.println("AT+CWJAP=\""Ajith ajay"\",\""12345678"\"");  // set your home router SSID and password
  showResponse(5000);
